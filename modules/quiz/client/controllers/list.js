...
(function(){
    /*
     * Creating List controller and attaching it to the main quizFacts module
     */
    angular
        .module("quiz")
    ...
    function ListController(quizMetrics, DataService){
        ...
        vm.data = DataService.quizsData; // Controller reference to the quiz info created in the factory
        vm.activeQuiz = {}; // will be used in the view to hold the data of currently active quiz
        vm.changeActiveQuiz = changeActiveQuiz; // reference to a named function below
        ...
        function changeActiveQuiz(index){
            // simple function to attach the data of the quiz clicked on to 
            // the active quiz object
            vm.activeQuiz = index;
        }
